  ...
  return (
    <>
      <ServiceStructuredData
        name="AIチャット形式メール作成ツール"
        description="AIとの対話でビジネスメールを作成。チャット形式で自然な会話をしながら、適切なメール文章を自動生成します。複雑な要件も対話で簡単に伝えられます。"
        url="https://madeforx.com/mail-generator/chat"
      ...
      <BreadcrumbStructuredData
        items={[
          ...
          { name: 'AIチャット形式メール作成', url: 'https://madeforx.com/mail-generator/chat' },
        ]}
      />
