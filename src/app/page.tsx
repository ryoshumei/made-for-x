...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Made for Xは、日本での生活とビジネスを効率化する無料Webツール集です。AIメール作成、メルカリ配送料計算、千葉県ごみ収集スケジュール、日本郵便輸出インボイス、休憩タイマー、祝日カウントダウン、韓国ビザ申請書入力ツールなど、日常で役立つツールを提供しています。',
  },
  {
    question: 'どのようなツールが利用できますか？',
    answer:
      '7つの主要ツールを提供：(1) AIメール作成ツール、(2) メルカリ配送料計算器、(3) 千葉県ごみ収集スケジュール、(4) 日本郵便輸出インボイス作成、(5) 休憩タイマー、(6) 祝日カウントダウン・連休プランナー、(7) 韓国ビザ申請書入力ツール。',
  },
  {
    question: '利用は無料ですか？',
    answer:
