    ...
    try {
        const completion = await openai.chat.completions.create({
            ...
            messages: [
                {
                    role: "system",
                    content: "You are an assistant that provides customs codes for products. Respond only with the 6-digit HS code, without any additional text or explanation."
                },
                {
                    role: "user",
