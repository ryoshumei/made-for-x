...
if (!process.env.DATABASE_URL) {
  ...
  process.env.DATABASE_URL = "postgresql://neondb_owner:npg_vj2h1ASQgtWr@ep-rapid-paper-a469wf0k-pooler.us-east-1.aws.neon.tech/neondb?sslmode=require&channel_binding=require";
